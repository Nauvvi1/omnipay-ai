...
7. Run safe simulation, or switch to real wallet transaction preview to open Tonkeeper.
...
Safe simulation mode does not send a transaction. Real wallet transaction preview opens a real Tonkeeper transaction; confirming spends TON.
